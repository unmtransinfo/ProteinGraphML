...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pythonTr",
        required=True,
        help="Python classification results file for training data",
    )
    parser.add_argument(
        "--pythonPr",
        required=True,
        help="Python classification results file for prediction data",
    )
    parser.add_argument(
        "--rTr",
        required=True,
        help="R classification results file for training data",
    )
    parser.add_argument(
        "--rPr",
        required=True,
    ...
    n = (
        round(len(pythonListTr), -2) + 200
        if len(pythonListTr) > round(len(pythonListTr), -2)
        else round(len(pythonListTr), -2) + 100
    )
